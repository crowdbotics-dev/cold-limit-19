"""
Django settings for cold_limit_19 project.
...
ROOT_URLCONF = 'cold_limit_19.urls'
...
WSGI_APPLICATION = 'cold_limit_19.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_limit_19 API",
    "DESCRIPTION": "API documentation for cold_limit_19 App",
    "VERSION": "v1",
}
